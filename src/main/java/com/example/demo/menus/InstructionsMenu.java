...
public class InstructionsMenu extends MenuParent {
    ...
    private static final String BACKGROUND_IMAGE_PATH = "/com/example/demo/images/menus/InstructionsMenu.png";
    private static final String HOME_BUTTON_IMAGE = "/com/example/demo/images/buttons/HomeButton.png";
